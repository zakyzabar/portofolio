...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio |  Zacky Anugrah Akbar";
...
var typed = new Typed(".typing-text", {
    strings: ["Front-End Developer", "Web Developer", "Teknisi Komputer", "IT Support", "Mahasiswa"],
    loop: true,
    typeSpeed: 90,
    backSpeed: 120,
    backDelay: 500,
...
async function fetchData(type = "skills") {
    ...
    if (type === "skills") {
        ...
        response = await fetch("./certificate/certificates.json");
    }
...
function showProjects(projects) {
    ...
    function showCertificates(certificates) {
        ...
        let certificateHTML = "";
        certificates.slice(0, 100).filter(certificate => certificate.category != "android").forEach(certificate => {
            certificateHTML += `
            <div class="box tilt">
          <img draggable="false" src="/assets/images/certification/${certificate.image}.png" alt="certificate" />
          <div class="content">
            <div class="tag">
